...
2. 🏗️ train_model.py sebagai arsitektur CNN serta menggunakan framework TensorFlow, untuk memperbagus dapat ditingkatkan melalui Hyperparameter Tuning, seperti menaikkan jumlah Epoch atau menyesuaikan learning rate pada Adam Optimizer
